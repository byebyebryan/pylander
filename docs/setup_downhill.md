...
`setup_downhill` is the downhill member of the setup-transfer trio for unified `zem_zev` guidance.
...
uv run python main.py sim setup_downhill:mid:0 --bot zem_zev
