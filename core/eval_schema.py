...
BOT_ZEM_RESULT_FIELDS: tuple[str, ...] = (
    ...
    "bot_zem_zev_flare_probe_count",
    "bot_zem_zev_flare_probe_ms_mean",
    "bot_zem_zev_flare_probe_ms_p90",
    "bot_zem_zev_flare_gate_mode",
    "bot_zem_zev_flare_gate_horizon_s",
    "bot_zem_zev_flare_gate_terminal_speed",
    "bot_zem_zev_flare_gate_peak_accel_ratio",
    "bot_zem_zev_flare_gate_od_excess_s",
    "bot_zem_zev_flare_gate_latest_safe_margin_s",
