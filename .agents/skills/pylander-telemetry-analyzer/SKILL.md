...
`uv run python .agents/skills/pylander-telemetry-analyzer/scripts/analyze_telemetry.py [--benchmark-json <path>] [--compare-json <path>] [--sim-log <path> ...] [--bot <bot>] [--max-findings <n>] [--output-report <path>]`
