...
- executor: `.agents/skills/pylander-tune-loop-manager/scripts/run_tune_loop.py`
- output contract: `.agents/skills/contracts/tune_loop_report.v1.json`

## Command

`uv run python .agents/skills/pylander-tune-loop-manager/scripts/run_tune_loop.py --input <input_json> --output <output_json>`
