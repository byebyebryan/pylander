...
from game.core.components import Radar, RefuelConfig, SensorReadings, Transform
from game.core.ecs import System
from game.core.sensor import get_proximity_contact, get_radar_contacts
...
class SensorUpdateSystem(System):
    ...
    def update(self, dt: float) -> None:
        ...
        for entity in self.world.get_entities_with(
            Transform, Radar, RefuelConfig, SensorReadings
        ):
