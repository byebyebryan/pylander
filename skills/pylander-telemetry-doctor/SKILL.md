---
name: pylander-telemetry-doctor
...
`uv run python skills/pylander-telemetry-doctor/scripts/analyze_telemetry.py [--benchmark-json <path>] [--compare-json <path>] [--sim-log <path> ...] [--bot <bot>] [--eval-mode <mode>] [--max-findings <n>] [--output-report <path>]`
