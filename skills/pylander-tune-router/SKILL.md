...
- executor: `skills/pylander-tune-router/scripts/route_tuning.py`
- output contract: `skills/contracts/route_decision.v1.json`

## Command

`uv run python skills/pylander-tune-router/scripts/route_tuning.py --input <input_json> --output <output_json>`
