...
def route_tuning(payload: dict[str, Any]) -> dict[str, Any]:
    ...
    if recommended_route == "arena":
        cmd = (
            "uv run python skills/pylander-tune-arena/scripts/run_tune_arena.py "
            "--input outputs/skills/pylander-tune-arena/input.json "
            "--output outputs/skills/pylander-tune-arena/report.json"
        )
        target_skill = "pylander-tune-arena"
        ...
        cmd = (
            "uv run python skills/pylander-tune-loop/scripts/run_tune_loop.py "
            "--input outputs/skills/pylander-tune-loop/input.json "
            "--output outputs/skills/pylander-tune-loop/report.json"
        )
        target_skill = "pylander-tune-loop"
        handoff_payload = {
