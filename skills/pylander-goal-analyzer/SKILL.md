...
- `uv run python skills/pylander-benchmark-runner/scripts/run_cached_benchmark.py --mode focused --selectors <selector_scope...> --seed-spec 0-4 --baseline-ref <baseline_ref> --bot <bot>`
...
`uv run python skills/pylander-strategy-orchestrator/scripts/run_strategy_arena.py --input <arena_input_json> --output <arena_output_json> --no-execute-workers`
