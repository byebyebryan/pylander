...
- `uv run python skills/pylander-benchmark/scripts/build_selector_pack.py --mode smoke`
- `uv run python skills/pylander-benchmark/scripts/build_selector_pack.py --mode quick --workers 12`
