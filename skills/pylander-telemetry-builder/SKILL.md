...
`uv run python skills/pylander-telemetry-builder/scripts/plan_telemetry.py --triage-report <path> [--scope <token> ...] [--overhead-budget-avg-ms <f>] [--overhead-budget-p99-ms <f>] [--output-plan <path>]`
