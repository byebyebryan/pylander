...
def route_tuning(payload: dict[str, Any]) -> dict[str, Any]:
    ...
    if recommended_route == "arena":
        cmd = (
            "uv run python skills/pylander-tune-orchestrator/scripts/run_tune_arena.py "
            "--input outputs/skills/pylander-tune-orchestrator/input.json "
            "--output outputs/skills/pylander-tune-orchestrator/report.json"
        )
        ...
        cmd = (
            "uv run python skills/pylander-tune-loop-manager/scripts/run_tune_loop.py "
            "--input outputs/skills/pylander-tune-loop-manager/input.json "
            "--output outputs/skills/pylander-tune-loop-manager/report.json"
        )
